...
export function createWhitelistAddedEvent(user: Address): WhitelistAdded {
...
export function createWhitelistRemovedEvent(user: Address): WhitelistRemoved {
  let whitelistRemovedEvent = changetype<WhitelistRemoved>(newMockEvent())

  whitelistRemovedEvent.parameters = new Array()

  whitelistRemovedEvent.parameters.push(
    new ethereum.EventParam("user", ethereum.Value.fromAddress(user))
  )

  return whitelistRemovedEvent
}
